...
#制定离散规则
split_policy={"E_RAB_Estab.-SR":["+",[98.5,99.5]],
        "RRC_Recon._rate":["-",[1,2]],
        "RRC_Estab.-SR":["+",[98.5,99.5]],
        "DL_PRB_avg_Utilz._rate":["-",[40,80]],
       "Maximum_num_of_users":["-",[100,200]],
       "Mean_num_of_users":["-",[70,150]],
       "UL_PRB_avg_Utilz._rate":["-",[80,40]],
       "UE_Context_DR":["-",[0.1,0.2]],
       "E_RAB_Context_DR":["-",[0.07,0.15]],
       "DL_avg_Pckt_delay":["-",[20,35]],
       "Inner_HO-SR":["+",[96,98]],
       "X2_HO-SR":["+",[90,95]],
       "RSRP_Coverage_rate":["+",[80,90]],
       "CQI_up_seven":["+",[85,95]],
       "RSSI":["-",[-95,-85]],
       "Avg_distance":["-",[350,700]]}
feature_columns=[x for x in list(df.columns[1:]) if x in split_policy]
print('feature_columns: 被选择来离散化的列的index： ')
